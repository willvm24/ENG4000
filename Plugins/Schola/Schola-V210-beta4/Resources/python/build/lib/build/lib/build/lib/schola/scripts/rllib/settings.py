...
class TrainingSettings:
    ...
    learning_rate: Annotated[float, Parameter(validator=validators.Number(gt=0))] = (
        0.0003
    )
...
class RLlibScriptArgs:
    ...
    checkpoint_settings: Annotated[
        CheckpointArgs, Parameter(group="Checkpoint Arguments")
    ] = field(default_factory=CheckpointArgs)
